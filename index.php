...
{
    $ip = $_GET['ip'];
    $out = shell_exec("python3 Recognition_opencv.py 1 ".$ip );
    header('Location: index.php');
    die();
}
else if ( $_GET['web'] == "True")
{
  $out = shell_exec("python3 Recognition_opencv.py 3");
  header('Location: index.php');
  die();
}
else if (isset($_GET['name']) )
{
  $out = shell_exec("python3 Recognition_opencv.py 2 ".$_GET['name']);
  header('Location: index.php');
  die();
}
?>